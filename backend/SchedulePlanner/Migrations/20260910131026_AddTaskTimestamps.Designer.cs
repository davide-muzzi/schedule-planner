...
namespace SchedulePlanner.Migrations
{
    ...
    [Migration("20260910131026_AddTaskTimestamps")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchedulePlanner.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SchedulePlanner.Models.TaskItem", b =>
                {
                    b.HasOne("SchedulePlanner.Models.TaskItem", "ParentTask")
                        .WithMany("Subtasks")
            ...
            modelBuilder.Entity("TagTaskItem", b =>
                {
                    b.HasOne("SchedulePlanner.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SchedulePlanner.Models.TaskItem", null)
                        .WithMany()
